from scripts.challenge_setup.puppet import UNISWAP_INITIAL_TOKEN_RESERVE
from scripts.challenge_setup.puppet_v2 import UNISWAP_INITIAL_WETH_RESERVE
...
set_account_balance_hardhat(attacker.address, hex(ether_to_wei(0.5)))
